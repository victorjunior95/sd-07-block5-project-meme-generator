window.onload = function () {
  ...
  chooseImage.addEventListener('change', function (event) {
    containerImage.src = URL.createObjectURL(event.target.files[0]); containerImage.onload = function () { URL.revokeObjectURL(containerImage.src); }; });
  buttonFire.addEventListener('click', function () {
    buttonFire = document.getElementById('meme-image-container'); buttonFire.style.border = '3px dashed red'; });
  buttonWater.addEventListener('click', function () {
    buttonWater = document.getElementById('meme-image-container'); buttonWater.style.border = '5px double blue'; });
  buttonEarth.addEventListener('click', function () {
    buttonEarth = document.getElementById('meme-image-container'); buttonEarth.style.border = '6px groove green'; });
